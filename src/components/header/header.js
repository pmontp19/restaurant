...
const Header = () => {
  ...
  return (
    <nav class="sticky top-0 z-40 backdrop-blur transition-colors duration-500 bg-g:border-slate-900/10 dark:border-slate-50/[0.06] bg-white/90 supports-backdrop-blur:bg-white/60 dark:bg-slate-900/90 px-2 sm:px-4 py-2.5 uppercase">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="/" class="flex items-center">
          <img
            src="/assets/images/mini.webp"
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul class="flex flex-col p-4 mt-4 text-slate-700 dark:text-slate-200 rounded-lg border dark:border-gray-100 border-gray-700 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  ">
            <li>
              <Link
                href="/"
                onClick={toggleMenu}
